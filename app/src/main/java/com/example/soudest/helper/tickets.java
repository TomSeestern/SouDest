...
public class tickets {
    ...
    public static List<ticketOBJ> getAllTicketsFromDB(){
        ...
        String json = "{\"RequestID\":123,\"TimeStamp\":1562411774,\"Valid Until\":1562441774,\"Tickets\":[{\"TicketID\":\"DB-AR-0815\",\"TotalTime\":15200,\"StartTime\":1562451774,\"EndTime\":1562466974,\"TotalPath\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[30,10],[10,30],[40,40]]},\"Transfers\":2,\"TotalPrice\":251.5,\"Connections\":[{\"ConnectionID\":\"DB-RE-272-84214423\",\"TransportType\":\"Train\",\"Description\":\"DB-RE-272\",\"TotalTime\":\"5200\",\"Price\":\"201.00\",\"StartTime\":1562451774,\"EndTime\":1562466974,\"Path\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[30,10],[10,30]]}},{\"ConnectionID\":\"BayerReisen213-23\",\"TransportType\":\"Bus\",\"Description\":\"Bayer Reisen Linie 27\",\"TotalTime\":\"10000\",\"Price\":\"50.50\",\"StartTime\":1562451774,\"EndTime\":1562466974,\"Path\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[10,30],[40,40]]}}]},{\"TicketID\":\"DB-AR-0815\",\"TotalTime\":15200,\"StartTime\":1562451774,\"EndTime\":1562466974,\"TotalPath\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[30,10],[10,30],[40,40]]},\"Transfers\":2,\"TotalPrice\":251.5,\"Connections\":[{\"ConnectionID\":\"DB-RE-272-84214423\",\"TransportType\":\"Train\",\"Description\":\"DB-RE-272\",\"TotalTime\":\"5200\",\"Price\":\"201.00\",\"StartTime\":1562451774,\"EndTime\":1562466974,\"Path\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[30,10],[10,30]]}},{\"ConnectionID\":\"BayerReisen213-23\",\"TransportType\":\"Bus\",\"Description\":\"Bayer Reisen Linie 27\",\"TotalTime\":\"10000\",\"Price\":\"50.50\",\"StartTime\":1562451774,\"EndTime\":1562466974,\"Path\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[10,30],[40,40]]}}]},{\"TicketID\":\"DB-AR-0815\",\"TotalTime\":15200,\"StartTime\":1562451774,\"EndTime\":1562466974,\"TotalPath\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[30,10],[10,30],[40,40]]},\"Transfers\":2,\"TotalPrice\":251.5,\"Connections\":[{\"ConnectionID\":\"DB-RE-272-84214423\",\"TransportType\":\"Train\",\"Description\":\"DB-RE-272\",\"TotalTime\":\"5200\",\"Price\":\"201.00\",\"StartTime\":1562451774,\"EndTime\":1562466974,\"Path\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[30,10],[10,30]]}},{\"ConnectionID\":\"BayerReisen213-23\",\"TransportType\":\"Bus\",\"Description\":\"Bayer Reisen Linie 27\",\"TotalTime\":\"10000\",\"Price\":\"50.50\",\"StartTime\":1562451774,\"EndTime\":1562466974,\"Path\":{\"type\":\"LineString / GEOJSON\",\"coordinates\":[[10,30],[40,40]]}}]}]}";
        ...
        try {
            ...
            for (int i=0; i < TicketArray.length(); i++) {
                ...
                for (int x=0;x <ConnectionArray.length();x++){
                    ...
                    SingleConnObj=new connectionOBJ(SingleConnection.getString("ConnectionID"),SingleConnection.getString("TransportType"),SingleConnection.getString("Description"),SingleConnection.getDouble("TotalTime"),SingleConnection.getDouble("Price"),SingleConnection.getDouble("StartTime"),SingleConnection.getDouble("EndTime"),0.0,0.0,0.0,0.0 );
